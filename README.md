...
AI automation developer and consultant. I build AI agents, voice agents, and automated workflows for small businesses.
...
- AI phone receptionists and voice agents (VAPI, ElevenLabs)
- Automated content pipelines (Claude + n8n + Cloudinary + LinkedIn)
- Multi-agent orchestration with Claude Code
- Lead gen automation (Apollo + Million Verifier + Instantly)
- Full-stack web apps (Next.js, React, Supabase, Vercel)
